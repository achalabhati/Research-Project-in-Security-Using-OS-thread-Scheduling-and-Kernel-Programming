...
for i in range(0,len(all_elements)):
	...
	res=all_elements[i][0]+","+all_elements[i][2]+","+all_elements[i][3]+","+all_elements[i][4]+","+all_elements[i][5]+","+all_elements[i][6] +","+all_elements[i][7] +","+all_elements[i][8]+","+all_elements[i][9]+","+all_elements[i][10]+","+all_elements[i][11] +"\n"
	
	if(int(all_elements[i][0]) >29 and (int(all_elements[i][4])+int(all_elements[i][5])+int(all_elements[i][6]) +int(all_elements[i][7]) +int(all_elements[i][8])+int(all_elements[i][9])+int(all_elements[i][10])+int(all_elements[i][11]))>0):
		start_flag=1	
