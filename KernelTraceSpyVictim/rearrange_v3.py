...
for i in range(0,len(all_elements)):
	...
	if(int(all_elements[i][0]) >19): # and (int(all_elements[i][4])+int(all_elements[i][5])+int(all_elements[i][6]) +int(all_elements[i][7]) +int(all_elements[i][8])+int(all_elements[i][9])+int(all_elements[i][10])+int(all_elements[i][11]))>0):
		start_flag=1	
